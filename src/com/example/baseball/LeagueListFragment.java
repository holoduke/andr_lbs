...
public class LeagueListFragment extends ListFragment implements OnItemClickListener{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		lgs.add(new League("USA: NBA"));
		lgs.add(new League("USA: NHL"));
		lgs.add(new League("USA: WNBA"));
		lgs.add(new League("USA: DKJU"));
		lgs.add(new League("USA: College Girls"));
